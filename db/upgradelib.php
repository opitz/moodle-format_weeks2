...
function format_weeks2_upgrade_remove_numsections() {
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_weeks2_upgrade_hide_extra_sections($courseid, $numsections);
    }

    foreach ($needsections as $courseid => $numsections) {
        format_weeks2_upgrade_add_empty_sections($courseid, $numsections);
    }
 ...
 */
function format_weeks2_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
 ...
 * @param int $numsections
 */
function format_weeks2_upgrade_add_empty_sections($courseid, $numsections) {
    global $DB;
