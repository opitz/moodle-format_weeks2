@format @format_weeks2
Feature: Sections can be edited and deleted in weeks2 format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete weeks2
  ...
  Scenario: Deleting the last section in weeks2 format
  ...
  Scenario: Deleting the middle section in weeks2 format
